...
import {UserData , additionalInformation}  from '../../utils/firebase/firebase.utils' ;
   ...
   export type  SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS,{user:string ,additionalDetails:string}>
   ...
   export const signUpSuccess =withMatcher((user:string , additionalDetails:string):SignUpSuccess=>
